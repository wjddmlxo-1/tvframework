package tvframework.let.uat.uia.service.impl;

import tvframework.com.cmm.LoginVO;
import tvframework.let.uat.uia.service.LoginService;
import tvframework.let.utl.fcc.service.NumberUtil;
...
public class LoginServiceImpl extends AbstractServiceImpl implements LoginService {
	...
	@Override
	public boolean existsLoginId(String id) throws Exception {
		if (id == null || id.trim().isEmpty()) {
			return false;
		}
		return loginDAO.existsLoginId(id.trim()) > 0;
	}
