...
public class LoginVO implements Serializable{
	...
	@Schema(description = "사용자구분", allowableValues = {"GNR", "ENT", "USR", "ADM"}, defaultValue = "USR")
	private String userSe; //사용자구분코드 ADM 추가
	...
	@Schema(description = "로그인후 이동할 페이지")
	private String url;
	
	@Schema(description = "사용자 IP정보")
	private String ip;
	
	@Schema(description = "GPKI 인증 DN")
	private String dn;
