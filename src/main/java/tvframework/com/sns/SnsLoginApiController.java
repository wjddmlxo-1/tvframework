...
import tvframework.com.jwt.JwtTokenUtil;
import tvframework.com.sns.SnsVO.NaverProfileVO;
import tvframework.com.sns.SnsVO.NaverResponseVO;
import tvframework.com.sns.SnsVO.NaverTokenVO;
import tvframework.com.sns.SnsVO.KakaoTokenVO;
import tvframework.com.sns.SnsVO.KakaoProfileVO;
import tvframework.com.sns.SnsVO.KakaoResponseVO;
import tvframework.let.uat.uia.service.LoginService;
...
public class SnsLoginApiController {
	...
	/** SNS */
	public static final String NAVER_CLIENT_ID = AppProperties.getProperty("Sns.naver.clientId");
	public static final String NAVER_CLIENT_SECRET = AppProperties.getProperty("Sns.naver.clientSecret");
	public static final String NAVER_CALLBACK_URL = AppProperties.getProperty("Sns.naver.callbackUrl");
	public static final String KAKAO_CLIENT_ID = AppProperties.getProperty("Sns.kakao.clientId");
	public static final String KAKAO_CALLBACK_URL = AppProperties.getProperty("Sns.kakao.callbackUrl");
